...
module.exports = {
  ...
  async execute(interaction) {
    ...
    return await interaction.reply({ content: "You **do not** have permission to do that!", ephemeral: true });
    ...
    switch (sub){
      ...
      if(boosterdata) return interaction.reply({ content : `You **already** have a booster channel (<#${boosterdata.Channel}>)`, ephemeral: true})
        ...
        const embed = new EmbedBuilder()
          ...
          .setTimestamp()
          .setFields({ name: `Channel was Set`, value: `>The channel ${Channel1} has been \n set as your Booster channel.`, inline: false})
      ...
      if (!interaction.member.permissions.has(PermissionsBitField.Flags.Administrator))
         ...
         if(!boosterdatas) return await interaction.reply({ content: `You **do not** have a booster channel yet.`, ephemeral: true}) 
          ...
          .setTimestamp()
          .setFields({ name: `Your channel was removed`, value: `> your channel for Booster has no longer in your server`, inline: false})
          .setThumbnail('https://cdn.discordapp.com/emojis/1085198386443075706.gif?size=96&quality=lossless')
